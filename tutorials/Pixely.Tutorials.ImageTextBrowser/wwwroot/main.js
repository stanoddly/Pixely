...
// Both probes are plain synchronous calls. Nothing here awaits, which is the point: the prediction
// was that decoding and font loading would have to become asynchronous in the browser.
console.log(program.ImageProbe());
console.log(program.FontProbe());
