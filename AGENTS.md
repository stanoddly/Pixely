...
- `docs/observations.md` - Pixely.Observations: appending value entries, per-reader cursors, trimming behind the slowest reader, capacity and stall detection, registration
