...
- `docs/sdk.md` - Pixely as an MSBuild project SDK: the `<Sdk Name="Pixely" />` line, what it adds to a project, central package management, the PackageReference migration error, the package layout
