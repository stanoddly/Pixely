...
- `docs/render-pass-flow.md` - Rendering architecture overview, CommandBuffer vs RenderPass, reused frame objects and their pool contract, the stack-only RenderPassBuilder, push constants, binding order
