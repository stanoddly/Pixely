...
- `docs/sdk.md` - Pixely as an MSBuild project SDK: the `<Sdk Name="Pixely" />` line, what it adds to a project, central package management, the PIXELY0002 error for projects without it, the package layout
