...
- `docs/render-pass-flow.md` - Rendering architecture overview, CommandBuffer vs RenderPass, reused frame objects and their pool contract, GPU validation turning reuse off, push constants, binding order
