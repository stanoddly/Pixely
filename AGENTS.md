...
- `docs/input-automation.md` - Synchronous synthetic mouse, keyboard, and text input, coordinate semantics, view targeting, physical-input boundaries, the standard-input command protocol, offscreen rendering and screenshots
